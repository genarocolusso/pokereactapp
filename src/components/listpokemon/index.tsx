...
export const Listpokemon = ({ pokemonTeam, teamView }: ListpokemonProps) => {
  const { pokemonUserState, handleDeletePokeTeam, handleAddPokeTeam } =
    usePokemonTeam();
          ...
          <>
            <Button
              ...
              onClick={() =>
                handleAddPokeTeam({
                  data: pokemons,
                  teamNumber: pokemonUserState.pokemonTeams.length,
                })
              }
            >
              Save Team
            ...
            <Button
              ...
              color={"white"}
              onClick={() =>
                handleDeletePokeTeam(pokemonUserState.currentTeam.teamNumber)
              }
            >
              Delete Team
            </Button>
