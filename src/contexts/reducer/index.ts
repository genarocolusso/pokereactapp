  ...
  switch (action.type) {
    case pokemon_actions.ADD_POKEMON:
      return {
        ...
        currentTeam: {
          ...state.currentTeam,
          data: [...state.currentTeam.data, action.newPokemon],
        },
      };
    ...
    case pokemon_actions.LOAD_TEAM:
      return {
        ...
        currentTeam: {
          ...
          teamNumber: action.payload.Number,
        },
      };
    case pokemon_actions.SET_CURRENT_SHINY:
      return {
        ...
        currentTeam: {
          ...state.currentTeam,
          data: [
            ...state.currentTeam.data.map((poke) => {
    ...
    case pokemon_actions.DELETE_TEAM:
      return {
        ...
        currentTeam: { data: [], teamNumber: 0 },
        pokemonTeams: [
          ...state.pokemonTeams.filter((team, idx) => idx !== action.index),
        ].map((team, idx) => {
          return { ...team, teamNumber: idx };
        }),
      };
    case pokemon_actions.SAVE_TEAM:
      return {
        ...
        currentTeam: {
          ...state.currentTeam,
          teamNumber: state.pokemonTeams.length,
        },
        pokemonTeams: [...state.pokemonTeams, { ...action.pokemonsTeam }],
      };
